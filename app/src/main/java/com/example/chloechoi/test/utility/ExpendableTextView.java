...
public class ExpendableTextView extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener {
    ...
    public ExpendableTextView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        post(new Runnable()
        {
            public void run()
            {
                if (getLineCount()>MAX_LINES)
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.switch_thumb);
                else
